...
" Install these
let g:coc_global_extensions = ['coc-pyright', 'coc-css', 'coc-html', 'coc-json', 'coc-yaml', 'coc-snippets', 'coc-explorer', 'coc-git', 'coc-sh', 'https://github.com/rodrigore/coc-tailwind-intellisense', 'coc-tsserver', 'coc-eslint']
